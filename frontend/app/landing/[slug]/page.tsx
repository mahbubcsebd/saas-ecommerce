...
export default async function LandingPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans" style={{ "--primary-color": page.themeColor } as React.CSSProperties}>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 p-4 bg-white border-t shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
        <a href="#order-form" className="block w-full bg-primary text-primary-foreground text-center font-bold py-3 rounded-lg shadow-lg animate-pulse">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
                ...
                <div className="text-center md:text-left space-y-6 order-2 md:order-1">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-4">
                        <a href="#order-form" className="px-8 py-4 bg-primary text-primary-foreground font-bold text-xl rounded-lg shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-1">
                            ORDER NOW
                        </a>
            ...
            <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-start">
                <div className="hidden md:block sticky top-24 space-y-6">
                    ...
                    <p className="text-gray-600 text-lg">
                        Please fill up the form to confirm your order. We accept Cash on Delivery, so you can pay after checking the product.
                    </p>
