    ...
    <div className="container py-12 md:py-24">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          {t('contact', 'subtitle', {
            defaultValue: 'We are here to help. Reach out to us for any queries.',
          })}
        </p>
      </div>
        ...
        <div className="space-y-8">
          <div className="bg-muted/30 p-8 rounded-2xl space-y-6">
            <h2 className="text-2xl font-semibold mb-6">
              {t('contact', 'infoTitle', { defaultValue: 'Get in Touch' })}
            </h2>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  {settings?.contact?.addressLine1 || '123 Main Street'}
                  <br />
              ...
              <div>
                ...
                <p className="text-muted-foreground space-y-1">
                  {settings?.contact?.phone && (
                    <span className="block">{settings.contact.phone}</span>
                  )}
                  {settings?.contact?.whatsapp && (
                    <span className="block">WhatsApp: {settings.contact.whatsapp}</span>
                  )}
                </p>
              </div>
            </div>
            ...
            {settings?.contact?.workingHours && (
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-medium">
                    {t('contact', 'workingHours', { defaultValue: 'Working Hours' })}
                  </h3>
                  <p className="text-muted-foreground">{settings.contact.workingHours}</p>
                </div>
              </div>
            )}
          </div>
