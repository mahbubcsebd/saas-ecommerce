      ...
      <div className="container mx-auto">
        ...
        <div className="flex items-center gap-1">
                ...
                >
                  {category.children.map((child: any) => (
                    <div key={child.id} className="space-y-3 break-inside-avoid">
                      <Link
                        ...
                        className="font-bold text-sm text-gray-900 dark:text-white hover:text-[#ef4a23] block border-b dark:border-zinc-800 pb-1.5 mb-2"
                      >
                  ...
                  {category.children.length > 0 && (
                    <div className="col-span-4 mt-2 pt-4 border-t border-gray-100 dark:border-zinc-800 flex justify-end">
                      <Link
                        href={`/categories/${category.slug}`}
                        className="text-xs font-bold text-[#ef4a23] hover:underline uppercase flex items-center gap-1"
                      >
          ...
          {categories.length > 12 && (
            <Link
              href="/categories"
              className="flex items-center text-[13px] font-bold px-4 py-3.5 hover:text-[#ef4a23] whitespace-nowrap uppercase tracking-wide"
            >
              All Categories
            </Link>
          )}
