...
export const NotificationBell = () => {
  ...
  const localUnread = notifications.reduce((acc, n) => acc + (n?.isRead ? 0 : 1), 0);
                ...
                return (
                  ...
                  >
                    <div className="flex w-full gap-3">
                      <div
                        className={`h-8 w-8 rounded-full flex items-center justify-center shrink-0 ${bgColor} ${iconColor}`}
                      >
