      ...
      <div className="container mx-auto flex h-16 items-center gap-4">
        ...
        <Link className="flex items-center space-x-2 shrink-0" href="/">
            {settings?.general?.headerLogo || settings?.general?.logoUrl ? (
                <img src={settings.general.headerLogo || settings.general.logoUrl} alt={settings.general.siteName} className="h-10 w-auto" />
            ) : (
              ...
              <SheetContent side="left" className="w-[300px] sm:w-[400px]">
                <div className="flex flex-col gap-6 py-4">
                   ...
                   <nav className="flex flex-col space-y-2">
                        ...
                        <Link href="/" className="px-2 py-1 hover:bg-muted rounded-md block">Home</Link>
                        <Link href="/products" className="px-2 py-1 hover:bg-muted rounded-md block">Products</Link>
                        <Link href="/categories" className="px-2 py-1 hover:bg-muted rounded-md block">Categories</Link>
                   </nav>
