...
export const ConfirmationProvider = ({ children }: { children: ReactNode }) => {
    ...
    const [options, setOptions] = useState<ConfirmationOptions & { resolve?: (val: boolean) => void }>({
        title: '',
        message: '',
    });
    ...
    const alert = useCallback((alertOptions: Omit<ConfirmationOptions, 'onConfirm' | 'onCancel'>): Promise<void> => {
        return new Promise((resolve) => {
            setOptions({
                ...alertOptions,
