...
export const ConfirmationModal = ({ isOpen, options, onClose }: ConfirmationModalProps) => {
    ...
    const buttonVariants: Record<ConfirmationType, "default" | "destructive" | "secondary" | "outline"> = {
        info: "default",
        success: "default",
        warning: "default",
        danger: "destructive",
        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && handleCancel()}>
            <DialogContent className="max-w-[400px] p-0 overflow-hidden border-none shadow-2xl rounded-3xl">
                ...
                <div className="p-8 pb-6 flex flex-col items-center text-center">
                    ...
                    <DialogTitle className="text-xl font-bold tracking-tight text-slate-900 mb-2">
                        {title}
                    </DialogTitle>
