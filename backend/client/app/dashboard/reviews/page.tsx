                ...
                <TableRow key={review.id} className="hover:bg-gray-50">
                  ...
                  <TableCell className="hidden sm:table-cell">
                    <div className="flex">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <svg
                          key={star}
                          className={`w-3 h-3 md:w-4 md:h-4 ${star <= review.rating ? "text-yellow-400" : "text-gray-300"
                            }`}
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                  ...
                  <TableCell>
                    <div className="flex flex-col gap-1 items-start">
                      <span
                        className={`px-2.5 py-1 rounded-full text-xs font-medium tracking-wide ${statusColors[review.status]
                          }`}
                      >
                        {review.status}
                      </span>
