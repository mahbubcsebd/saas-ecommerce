    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Growth, retention, and lifetime value from{' '}
      ...
      <Card className="shadow-md">
        <CardHeader>
          ...
          <CardDescription>
            Daily new customer registrations over the selected period
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="shadow-md">
        <CardHeader>
          ...
          <CardDescription>
            The most valuable customers based on total completed orders
          </CardDescription>
        </CardHeader>
