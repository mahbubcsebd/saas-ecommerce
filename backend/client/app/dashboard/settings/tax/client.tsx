  ...
  const handleRateDelete = async (id: string) => {
    if (
      !(await confirm({
        ...
        message:
          'Are you sure you want to delete this tax rate? This will permanently affect order calculations for the associated location.',
        type: 'danger',
  ...
  const handleClassDelete = async (id: string) => {
    if (
      !(await confirm({
        ...
        message:
          'Are you sure you want to delete this tax class? Products assigned to this class may have incorrect tax calculations until reassigned.',
        type: 'danger',
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b pb-8">
        <div className="space-y-1">
          ...
          <p className="text-slate-500 text-sm">
            Manage tax rates, classes, and regional tax compliance rules.
          </p>
        </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-xs">
                    Control how taxes are calculated across your store.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="p-6 space-y-6">
              <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 border border-slate-100">
                ...
                <Switch
                  ...
                  onCheckedChange={(val) =>
                    handleUpdateConfig({ isTaxEnabled: val })
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 border border-slate-100">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-slate-500">
                    Product prices already include tax (e.g., VAT inclusive).
                  </p>
                </div>
                <Switch
                  checked={taxConfig.taxInclusivePricing}
                  onCheckedChange={(val) =>
                    handleUpdateConfig({ taxInclusivePricing: val })
                  }
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                ...
                <div className="flex items-center justify-between p-4 rounded-xl border border-slate-100">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-slate-500">
                      Show VAT labels on store and invoices.
                    </p>
                  </div>
                  <Switch
                    checked={taxConfig.isVatEnabled}
                    onCheckedChange={(val) =>
                      handleUpdateConfig({ isVatEnabled: val })
                    }
                  />
                </div>
              </div>
        ...
        <TabsContent value="classes" className="space-y-6">
          <div className="flex items-center justify-between px-1">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Group tax rules for different product types.
              </p>
            </div>
            <Dialog
            ...
            >
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  <DialogTitle>
                    {editingClass ? 'Edit' : 'Add'} Tax Class
                  </DialogTitle>
                  <DialogDescription>
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              const ids = e.target.checked
                                ...
                                : classForm.taxRateIds.filter(
                                    (id: string) => id !== rate.id,
                                  );
              ...
              <Card className="col-span-full border-dashed p-12 flex flex-col items-center justify-center text-center space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-slate-500">
                    Create your first tax class to start applying taxes to
                    products.
                  </p>
                </div>
              </Card>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {tc.taxRates?.map((rate: any) => (
                          <span
                            key={rate.id}
                            className="px-2 py-0.5 bg-slate-100 text-[10px] font-medium text-slate-600 rounded border"
                          >
                            {rate.name} ({rate.rate}%)
                          </span>
                        ))}
        ...
        <TabsContent value="rates" className="space-y-6">
          <div className="flex items-center justify-between px-1">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Define location-specific tax percentages.
              </p>
            </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setRateForm({ ...rateForm, country: e.target.value })
                        }
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setRateForm({ ...rateForm, state: e.target.value })
                        }
