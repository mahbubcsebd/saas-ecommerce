    ...
    try {
      ...
      if (data.success && data.data) {
        ...
        if (seo) {
          ...
          const joinArray = (arr: string[] | undefined) =>
        ...
        <TabsContent value="company">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Displayed on invoices and footer
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  {...formCompany.register('invoiceTerms')}
              ...
              <div className="flex justify-end">
                <Button
                  disabled={saving}
                  onClick={formCompany.handleSubmit((d) =>
                    updateSettings('company', d),
                  )}
                >
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2 col-span-2">
                  ...
                  <Textarea
                    {...formGeneral.register('description')}
                    placeholder="Store description for SEO and footer..."
                  />
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                      ...
                      <ImageUpload
                        ...
                        onChange={(url) =>
                          formGeneral.setValue('headerLogo', url)
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <ImageUpload
                        ...
                        onChange={(url) =>
                          formGeneral.setValue('footerLogo', url)
                        }
                ...
                <div className="space-y-2 col-span-2">
                  ...
                  <Input
                    {...formGeneral.register('copyrightText')}
                    placeholder="© 2026 Mahbub Shop. All rights reserved."
                  />
                </div>
              </div>
              <div className="flex items-center space-x-2 border p-4 rounded-md">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    formGeneral.setValue('maintenanceMode', checked)
                  }
                />
              ...
              <div className="flex justify-end">
                <Button
                  disabled={saving}
                  onClick={formGeneral.handleSubmit((d) =>
                    updateSettings('general', d),
                  )}
                >
                  {saving && <Loader2 className="animate-spin mr-2 h-4 w-4" />}{' '}
                  Save Changes
        ...
        <TabsContent value="currency">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your store's primary currency
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(val: any) =>
                      formCurrency.setValue('symbolPosition', val)
                    }
                  >
                    <SelectTrigger>
              ...
              <div className="flex justify-end">
                <Button
                  disabled={saving}
                  onClick={formCurrency.handleSubmit((d) =>
                    updateSettings('currency', d),
                  )}
                >
                  {saving && <Loader2 className="animate-spin mr-2 h-4 w-4" />}{' '}
                  Save Changes
        ...
        <TabsContent value="contact">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Links for your footer and contact pages
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-8 pt-4">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      {...formContact.register('workingHours')}
              ...
              <div className="flex justify-end">
                <Button
                  disabled={saving}
                  onClick={formContact.handleSubmit((d) =>
                    updateSettings('contact', d),
                  )}
                >
                  {saving && <Loader2 className="animate-spin mr-2 h-4 w-4" />}{' '}
                  Save Changes
        ...
        <TabsContent value="seo">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Search Engine Optimization settings for your store
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  {...formSeo.register('metaDescription')}
              ...
              <div className="space-y-2">
                ...
                <Input
                  {...formSeo.register('metaKeywords')}
                  placeholder="shop, products, electronics"
                />
              </div>
              ...
              <div className="border-t pt-4 mt-4">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Enter one ID per line to add multiple.
                </p>
              ...
              <div className="flex justify-end">
                <Button
                  disabled={saving}
                  onClick={formSeo.handleSubmit((d) =>
                    updateSettings('seo', d),
                  )}
                >
                  {saving && <Loader2 className="animate-spin mr-2 h-4 w-4" />}{' '}
                  Save Changes
