        ...
        {sandboxKey && (
          <div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 border border-slate-100 mb-2">
            ...
            <div className="flex items-center gap-2">
              <span
                className={`text-[10px] font-bold ${!payment[sandboxKey] ? 'text-emerald-600' : 'text-slate-400'}`}
              >
                LIVE
              </span>
              <Switch
              ...
              />
              <span
                className={`text-[10px] font-bold ${payment[sandboxKey] ? 'text-blue-600' : 'text-slate-400'}`}
              >
                TEST
              </span>
            </div>
          ...
          {fields.map((f: any) => (
            <div key={f.key} className="space-y-1.5">
              ...
              <Input
                ...
                value={payment[f.key] || ''}
                onChange={(e) =>
                  setPayment({ ...payment, [f.key]: e.target.value })
                }
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b pb-8">
        <div className="space-y-1">
          ...
          <p className="text-slate-500 text-sm">
            Configure secure payment methods and API credentials for your store.
          </p>
        </div>
        ...
        <GatewayCard
          ...
          fields={[
            ...
            },
            {
              ...
              placeholder: 'Pay when receiving order',
            },
          ]}
        />
      </div>
