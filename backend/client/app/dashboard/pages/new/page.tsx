...
export default function NewCustomPage() {
  ...
  const fetchLanguages = async () => {
    try {
      const res = await fetchApi<{ success: boolean; data: Language[] }>('/languages/active');
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const res = await fetchApi<{ success: boolean; message: string }>('/pages', {
        method: 'POST',
        headers: {
      ...
      toast.error(err.message || 'Failed to create custom page');
    } finally {
      setSaving(false);
    }
  };
      ...
      <div className="flex items-center justify-between border-b pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">Write and publish dynamic storefront static pages.</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="pt-6 space-y-4">
              ...
              <div className="space-y-2">
                <Label>Custom Slug (URL URL Path)</Label>
                <Input
                ...
                <p className="text-[10px] text-muted-foreground">
                  Leave empty to automatically generate from the title. Must be unique.
                </p>
              </div>
            </CardContent>
          </Card>
