            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="outline" className={`h-5 text-[10px] font-bold uppercase tracking-widest border-none ${item.stock === 0 ? 'bg-rose-50 text-rose-600' : 'bg-amber-50 text-amber-600'
                    }`}>
