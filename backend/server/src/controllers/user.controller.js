...
const canModifyUser = (currentUserRole, targetUserRole, currentUserId, targetUserId) => {
...
exports.getAllUsers = asyncHandler(async (req, res) => {
  ...
  const validSortFields = ['createdAt', 'updatedAt', 'firstName', 'lastName', 'email', 'username'];
...
exports.updateUserRole = exports.roleUpdate = asyncHandler(async (req, res) => {
  ...
  if (!validRoles.includes(normalizedRole)) {
    throw ApiError.badRequest(
      'Invalid role. Valid roles are: CUSTOMER, STAFF, MANAGER, ADMIN, SUPER_ADMIN'
    );
  }
...
exports.toggleUserStatus = asyncHandler(async (req, res) => {
  ...
  // Check permissions
  if (!canModifyUser(currentUser.role, targetUser.role, currentUser.id, id)) {
