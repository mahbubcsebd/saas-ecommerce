...
exports.getSettingsByType = async (req, res, next) => {
  try {
    ...
    switch (type) {
      case 'general':
        data = await prisma.generalSetting.findFirst();
        break;
      case 'currency':
        data = await prisma.currencySetting.findFirst();
        break;
      case 'contact':
        data = await prisma.contactSetting.findFirst();
        break;
      case 'seo':
        data = await prisma.seoSetting.findFirst();
        break;
      case 'email':
        data = await prisma.emailSetting.findFirst();
        break;
      case 'appearance':
        data = await prisma.appearanceSetting.findFirst();
        break;
      case 'payment':
        data = await prisma.paymentSetting.findFirst();
        break;
      case 'order':
        data = await prisma.orderSetting.findFirst();
        break;
      case 'company':
        data = await prisma.companySetting.findFirst();
        break;
      case 'legal':
        data = await prisma.legalSetting.findFirst();
        break;
      case 'tax':
        data = await prisma.taxSetting.findFirst();
        break;
      case 'shipping':
        data = await prisma.shippingSetting.findFirst();
        break;
      case 'sms':
        data = await prisma.smsSetting.findFirst();
        break;
      case 'integrations':
        data = await prisma.integrationSetting.findFirst();
        break;
      case 'webhooks':
...
exports.updateSettings = async (req, res, next) => {
  try {
    ...
    switch (type) {
      case 'general':
        updated = await updateSingleton(prisma.generalSetting);
        break;
      case 'currency':
        updated = await updateSingleton(prisma.currencySetting);
        break;
      case 'contact':
        updated = await updateSingleton(prisma.contactSetting);
        break;
      case 'seo':
        updated = await updateSingleton(prisma.seoSetting);
        break;
      case 'email':
        updated = await updateSingleton(prisma.emailSetting);
        break;
      case 'appearance':
        updated = await updateSingleton(prisma.appearanceSetting);
        break;
      case 'payment':
        updated = await updateSingleton(prisma.paymentSetting);
        break;
      case 'order':
        updated = await updateSingleton(prisma.orderSetting);
        break;
      case 'company':
        updated = await updateCompany(prisma.companySetting);
        break;
      case 'legal':
        updated = await updateSingleton(prisma.legalSetting);
        break;
      case 'tax':
        updated = await updateSingleton(prisma.taxSetting);
        break;
      case 'shipping':
        updated = await updateSingleton(prisma.shippingSetting);
        break;
      case 'sms':
        updated = await updateSingleton(prisma.smsSetting);
        break;
      case 'integrations':
        updated = await updateSingleton(prisma.integrationSetting);
        break;
      default:
        return res.status(400).json({ success: false, message: 'Invalid setting type' });
    }
