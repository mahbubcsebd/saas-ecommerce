...
router.delete('/:id', authMiddleware, isManager, productIdValidation, validate, productController.deleteProduct);
...
router.post('/admin/import', authMiddleware, isManager, anyImageUpload('products'), productController.importProducts);

// ============================================
// PUBLIC DISCOUNT ROUTES
// ============================================
router.get('/discounts/active', discountController.getActiveDiscounts);
router.post('/discounts/validate', validateCouponValidation, validate, discountController.validateCouponCode);
...
router.post('/admin/discounts', authMiddleware, isAdmin, createDiscountValidation, validate, discountController.createDiscount);
router.get('/admin/discounts/:id', authMiddleware, isAdmin, discountIdValidation, validate, discountController.getDiscount);
router.put('/admin/discounts/:id', authMiddleware, isAdmin, updateDiscountValidation, validate, discountController.updateDiscount);
router.delete('/admin/discounts/:id', authMiddleware, isAdmin, discountIdValidation, validate, discountController.deleteDiscount);

// ============================================
// ADMIN INVENTORY ROUTES
// ============================================
router.get('/admin/inventory/movements', authMiddleware, isAdmin, inventoryQueryValidation, validate, inventoryController.getStockMovements);
router.post('/admin/inventory/adjust', authMiddleware, isAdmin, adjustStockValidation, validate, inventoryController.adjustStock);
router.post('/admin/inventory/bulk-update', authMiddleware, isAdmin, bulkStockUpdateValidation, validate, inventoryController.bulkStockUpdate);
