...
// ID specific routes
router.route('/:id').get(authMiddleware, returnController.getReturnById);

router.route('/:id/status').patch(authMiddleware, isManager, returnController.updateReturnStatus);
