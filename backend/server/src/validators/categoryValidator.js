...
const createCategoryValidation = [
  ...
  body('isHomeShown').optional().isBoolean().withMessage('isHomeShown must be a boolean'),
...
const categoryIdValidation = [param('id').isMongoId().withMessage('Invalid Category ID format')];

const categoryStructureValidation = [
  body('categories').isArray().withMessage('Categories must be an array'),

  body('categories.*.id').notEmpty().isMongoId().withMessage('Invalid Category ID in structure'),
