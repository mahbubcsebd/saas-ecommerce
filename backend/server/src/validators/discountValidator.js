...
const updateDiscountValidation = [
  ...
  body('name').optional().trim().notEmpty().withMessage('Discount name cannot be empty'),
...
const discountIdValidation = [param('id').isMongoId().withMessage('Invalid Discount ID format')];
