...
async function main() {
  ...
  const createVariants = (p, variantsData) => {
    ...
    return variantsData.map((v) => ({
      ...
      sku:
        v.sku ||
        `${p.slug.substring(0, 6)}-${Math.random().toString(36).substr(2, 5).toUpperCase()}`,
  ...
  const productsData = [
    ...
    },
    {
      ...
      images: [
        'https://images.unsplash.com/photo-1695421590506-c87cb71a1795?auto=format&fit=crop&q=80&w=800',
      ],
      variants: [
        {
          name: 'Bay / 128GB',
    ...
    // --- Electronics: Laptops ---
    {
      ...
      variants: [
        {
          name: 'Space Black / 1TB / 36GB',
          price: 3499.0,
          stock: 5,
          attributes: { Color: 'Space Black', Ram: '36GB' },
        },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        'https://images.unsplash.com/photo-1606841837239-c5a1a4a07afe?auto=format&fit=crop&q=80&w=800',
      ],
    ...
    // --- Fashion: Shoes ---
    {
      ...
      variants: [
        { name: 'Chicago / US 10', stock: 5, attributes: { Color: 'Red/White', Size: 'US 10' } },
      ],
    },
    {
      ...
      variants: [
        {
          ...
          stock: 3,
          attributes: { Wood: 'Walnut', Material: 'Leather' },
        },
      ],
    },
    {
    ...
    // --- Sports ---
    {
      ...
      images: [
        'https://images.unsplash.com/photo-1638531751811-12c858be16ea?auto=format&fit=crop&q=80&w=800',
      ],
    ...
    // --- Additional Electronics: Smartphones ---
    {
      ...
      variants: [
        {
          name: 'Glacial White / 256GB',
          price: 749.0,
          stock: 20,
          attributes: { Color: 'Glacial White', Storage: '256GB' },
        },
      ],
    },
    {
      ...
      images: [
        'https://images.unsplash.com/photo-1592286927505-b7e7857fe7c1?auto=format&fit=crop&q=80&w=800',
      ],
      variants: [
        {
    ...
    },
    {
      ...
      variants: [
        {
          name: 'Moonlight White / 32GB',
          price: 1599.0,
          stock: 10,
          attributes: { Color: 'White', Ram: '32GB' },
        },
      ],
    },
    // --- Additional Fashion ---
    ...
    // --- Additional Home & Kitchen ---
    {
      ...
      images: [
        'https://images.unsplash.com/photo-1584990347449-39b4aa8e8b7a?auto=format&fit=crop&q=80&w=800',
      ],
    ...
    },
    {
      ...
      variants: [
        { name: '5.5L Black', stock: 30, attributes: { Capacity: '5.5L', Color: 'Black' } },
      ],
    },
  ...
  for (const p of productsData) {
    ...
    if (!categoryId) {
      console.warn(
        `⚠️  Category slug '${categorySlug}' not found for product '${p.name}'. Skipping.`
      );
      continue;
    }
  ...
  await prisma.heroSlide.createMany({
    data: [
      {
        image:
          'https://images.unsplash.com/photo-1621330387607-b27a3c7943d1?auto=format&fit=crop&q=80&w=1600',
        title: 'New Arrivals',
